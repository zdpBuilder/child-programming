    ...
    const getModalContent = () => {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <FormItem label="校区名称" {...this.formLayout}>
          ...
          <FormItem label="校区负责人" {...this.formLayout}>
            {getFieldDecorator('owner', {
              rules: [{ required: true, message: '请选择校区负责人' }],
          ...
          <FormItem {...this.formLayout} label="校区描述">
            {getFieldDecorator('subDescription', {
              rules: [{ message: '请输入至少五个字符的校区描述！', min: 5 }],
