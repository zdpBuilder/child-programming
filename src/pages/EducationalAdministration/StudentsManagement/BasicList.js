  ...
  render() {
    ...
    const getModalContent = () => {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <FormItem label="学生名称" {...this.formLayout}>
          ...
          <FormItem label="学生负责人" {...this.formLayout}>
          ...
          <FormItem {...this.formLayout} label="学生描述">
            {getFieldDecorator('subDescription', {
              rules: [{ message: '请输入至少五个字符的学生描述！', min: 5 }],
    ...
    return (
      <PageHeaderWrapper>
        ...
        <Modal
          title={done ? null : `学生${current ? '编辑' : '添加'}`}
